...
public class GameBoard extends GridPane {
    ...
    //handles WASD block highlighting logic
    private GameBlock previousBlock;
    ...
    protected void build() {
        ...
        this.setOnMouseClicked(event -> rightClick(event));
    ...
    protected GameBlock createBlock(int x, int y) {
        ...
        //when mouse enters a block, highlight it
        block.setOnMouseEntered((e) -> block.hover());

        //when mouse leaves the block, remove highlighting
        block.setOnMouseExited((e) -> block.exit());
    ...
    public void setRightClickedListener(RightClickedListener listener) { this.rightClickedListener = listener; }

    private void rightClick(MouseEvent event) {
        if (rightClickedListener != null && event.getButton() == MouseButton.SECONDARY) {
            rightClickedListener.rightClick(event);
        }
    }

    public void currentBlock(GameBlock block) {
        previousBlock.exit();
        previousBlock = block;
        block.hover();
    }
    ...
    /**
     * for each coordinate, call the fadeOut() method on the respective block
     * @param coordinates
     */
